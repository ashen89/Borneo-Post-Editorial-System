                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="dashboard.php" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span>Reporter Dashboard </span> </a>
  ...
  <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="manage-categories.php">View Category</a></li>
                                </ul>
                            </li>
    ...
    <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="manage-subcategories.php">View Sub Category</a></li>
                                </ul>
                            </li>               
  <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="manage-posts.php">Approved Posts</a></li>
                                     <li><a href="trash-posts.php">Waiting for Approval</a></li>
                                </ul>
                            </li>  
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> borneopost@gmail.com</p>
                    </div>
