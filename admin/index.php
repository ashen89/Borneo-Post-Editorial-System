...
if(isset($_POST['login'])){
 ...
 if($count==1){
  ...
  break;
  case 'editor':
  header('Location: http://localhost/newsportal/editor/dashboard.php');
  break;
  case 'reporter':
  header('Location: http://localhost/newsportal/reporter/dashboard.php');
  break;
 }
 }else{
...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Borneo Post.">
        <meta name="author" content="AshenSachintha">
