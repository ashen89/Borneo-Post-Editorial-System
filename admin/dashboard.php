...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Borneo Post | Dashboard</title>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
<a href="manage-userprofile.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">User Profiles</p>
<?php $query=mysqli_query($con,"select * from tbluserprofile where Is_Active=1");
