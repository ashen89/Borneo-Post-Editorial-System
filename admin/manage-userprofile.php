...
<td><a href="edit-userprofile.php?scid=<?php echo htmlentities($row['UserProfileId']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
	&nbsp;<a href="manage-userprofile.php?scid=<?php echo htmlentities($row['UserProfileId']);?>&&action=del"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
</tr>
<?php
$cnt++;
 } ?>
