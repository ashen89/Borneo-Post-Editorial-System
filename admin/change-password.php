...
$sql=mysqli_query($con,"SELECT password FROM  user where username='$adminid' || AdminEmailId='$adminid'");
...
if (password_verify($password, $dbpassword)) {
 ...
 $con=mysqli_query($con,"update user set password='$newhashedpass', updationDate='$currentTime' where username='$adminid'");
